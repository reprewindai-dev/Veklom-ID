...
Veklom ID owns identity/trust events and identity-side verification. Identity scores must derive from attributable events and evidence; fabricated scores, static endorsements, or unverified payment claims must not be represented as production trust.
